...
export default function Tecnhologies() {
    const techStack = ['React', 'Next.js', 'Astro', 'Node.js', 'Python', 'AWS', 'Docker', 'PostgreSQL', 'Tailwind', 'TypeScript', 'GraphQL', 'n8n'];

    return (
        <section className="py-12 overflow-hidden bg-[#030712] border-t border-slate-800/50 relative">
            <p className="text-center text-slate-500 text-sm font-mono mb-8 uppercase tracking-widest">Powered by Modern Tech</p>
